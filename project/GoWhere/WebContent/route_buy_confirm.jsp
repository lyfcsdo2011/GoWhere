...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    border-top: 1px dashed #dddddd;
    	...
    	.liucheng div:nth-of-type(1) p {
		color: #333333;
	}
	.liucheng u:nth-of-type(1) {
		background-color: #2ac86e;
	}
	
	.liucheng div:nth-of-type(1) i {
		background-color: #2ac86e;
	}
	</style>
...
<jsp:include page="/header.jsp"   />
    <!-- 详情 start -->   
   <form action="users/CreateOrder.do?rid=${requestScope.order_route.rid}" method ="post">
    <div class="wrap">
        <div class="bread_box">
            <a href="/">首页</a>
            <span> &gt;</span>
            <a href="#">国内游</a><span> &gt;</span>
            <a href="#">${requestScope.order_route.rname }</a>
        </div>
       ...
       <div class="bread_box">
		 ...
		 <div class="bread_box">
				...
				<table class="tab-integral" style="width: 100%; margin: 20px auto 0;line-height:30px;" cellspacing="0" cellpadding="0" border="0">
					...
					<tbody>
						<tr><td style="padding: 10px 5px 10px 20px;width: 530px;" class="text-overflow">${requestScope.order_route.rname }
						<input type="hidden" name="orderSubject" value="${requestScope.order_route.rname }"></td>
						<td class="money-span">${requestScope.order_route.price }<input type="hidden" name="price" value="${requestScope.order_route.price }"></td>
						<td >1<input type="hidden" name="num" value="1"></td>
						<td>无<input type="hidden" name="discount" value="0"></td>
						<td class="money-span">${requestScope.order_route.price }<input type="hidden" name="amount" value="${requestScope.order_route.price }"></td>
						
						</tr>
					</tbody>
				</table>
		 	
		 		<div class="am-u-sm-12 am-u-sm-centerd"
					style="font-size: 2.4rem; text-align: center">
